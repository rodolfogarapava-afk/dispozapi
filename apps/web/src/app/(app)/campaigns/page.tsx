    ...
    <div className="app-page space-y-5">
      <section className="app-tool-shell">
        ...
        <div className="flex flex-wrap items-center justify-end gap-3 border-t border-border px-3 py-3 sm:px-4">
          ...
          <button type="button" onClick={() => void saveCampaign(true)} disabled={saving || loadingInstances} className="btn-primary w-full justify-center px-5 py-2.5 disabled:opacity-50 sm:w-auto">
            {saving ? <Loader2 className="h-4 w-4 animate-spin" /> : <Send className="h-4 w-4" />} Iniciar campanha
          </button>
        </div>
      </section>
